...
Of course, further criteria should be used to determine an "optimal" **lambda** for the use case at hand - but certainly feature importance provides helpful guidance for data of mixed types. 
